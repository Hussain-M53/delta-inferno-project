...
const Testimonials = () => {
  return (
    <section className="relative isolate overflow-hidden bg-white px-6 py-8 lg:px-8 border-b">
        ...
        {testimonials.map((testimonial, idx) => (
          <figure key={idx} className="mt-10 mx-10">
            ...
            <figcaption className="mt-10">
              <img className="mx-auto h-10 w-10 rounded-full" src={testimonial.image} alt={testimonial.author} />
