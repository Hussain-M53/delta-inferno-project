    ...
    return (
        <div className=' py-20 md:px-16 lg:px-28 bg-gray-900 sm:w-4/5 sm:rounded-3xl shadow-2xl mx-auto min-h-screen flex flex-col items-center'>
            ...
            <div className='mt-12 mb-6 flex gap-x-4 sm:gap-x-8 justify-between items-center '>
                <div onClick={() => setSelectedStep(0)} className={`${selectedStep == 0 ? 'bg-gray-700 text-white' : 'bg-white text-black'} px-4 py-1 sm:py-2 sm:px-10 rounded-md font-serif hover:bg-gray-300 hover:text-white`}>Step 1</div>
                <div onClick={() => setSelectedStep(1)} className={`${selectedStep == 1 ? 'bg-gray-700 text-white' : 'bg-white text-black'} px-4 py-1 sm:py-2 sm:px-10  rounded-md font-serif hover:bg-gray-300 hover:text-white`}>Step 2</div>
                <div onClick={() => setSelectedStep(2)} className={`${selectedStep == 2 ? 'bg-gray-700 text-white' : 'bg-white text-black'} px-4 py-1 sm:py-2 sm:px-10 rounded-md font-serif hover:bg-gray-300 hover:text-white`}>Step 3</div>
            ...
            <div className='px-10 md:px-0 flex flex-col items-center md:grid md:grid-cols-2 gap-x-4'>
                ...
                <div ref={cardRef} className={`mt-6 w-full md:m-auto h-full transform transition-all duration-700 ease-in-out ${isVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 translate-x-10 scale-95'} mt-10 md:mt-0 flex flex-col items-center md:items-start `}>
                    ...
                    <div className='text-white mt-4 md:mt-10 text-sm'>{steps[selectedStep]?.description}</div>
